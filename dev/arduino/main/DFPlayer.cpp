...
// void execute_CMD(Serial* serial, uint8_t CMD, uint8_t Par1, uint8_t Par2) {
void execute_CMD(Print *serial, uint8_t CMD, uint8_t Par1, uint8_t Par2)
{
...
SoundCard::SoundCard(Print *serial) { this->serial = serial; }
SoundCard::~SoundCard() {}
