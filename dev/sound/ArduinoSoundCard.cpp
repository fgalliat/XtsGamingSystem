 ...
 #include "SoundCard.h"
  ...
  // =============================
    ...
    void SoundCard::play(int track) {
		...
		char msg[16]; sprintf(msg, "MPL%d", track);
    ...
    void SoundCard::volume(int volPercent) {
		...
		char msg[16]; sprintf(msg, "MVL%d", volPercent);
		this->serial->write(msg, strlen(msg));
    	delay(100);
    }
