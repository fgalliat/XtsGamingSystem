...
//                            GBMain.getInstance().fb[yLookUp[currentLine] + tx] = forePal[colour][GB_MEM[323] < 0x80 ? ((int) ((sprF & 0x10) <= 0 ? 0 : 1)) : sprF & 7];
                    	//GBMain.instance.setPixel(yLookUp[currentLine] + tx, forePal[colour][GB_MEM[323] < 0x80 ? ((int) ((sprF & 0x10) <= 0 ? 0 : 1)) : sprF & 7]);
                    	
                        // moa may not support gbc
                        //setPixel(yLookUp[currentLine] + tx, forePal[colour*PAL_WIDTH + GB_MEM[323] < 0x80 ? ((int) ((sprF & 0x10) <= 0 ? 0 : 1)) : sprF & 7]);
